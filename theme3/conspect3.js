...
// RegExp
// g (от global) указывает на глобальный поиск, который ищет все совпадения,
//  а не прерывается после первого найденного.

// - - - - - - - - - - - - - - - - - 

// Флаг i (от ignore case) указывает на регистронезависимый поиск, игнорируя регистр букв.
// let test = "AetE werlE"
// let result = test.replace(/a/gi, "*")
// console.log(result)
...
//   .match() ищет совпадение только с начала строки,
// а .search() ищет совпадение во всей строке.
