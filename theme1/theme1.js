...
// Есть 3 вида ковычек: двойные(1), одинарные(2), боковые(3)- для переменных ${} ✅
...
// string - текст
// number - цифры
// bigint - В Java Script максимальная длина целых чисел 17, bigint() помогает тем что может принимать значения больше чем 17 
// boolean - правда/не правда/ - true/false 
// undefined - ошибка происходит к примеру когда наша переменная пустая и не имеет внутри значений
// null - ошибка происходит только тогда, когда мы хотим обратиться к переменной которая не существует
// symbol - символы 
// object - В JavaScript объект представляет собой коллекцию ключ-значение, и иметь внутри себя даже методы
...
// Есть 3 вида переменных - var, let, const 
...
// console в GOOGLE является продолжением JavaScript 
